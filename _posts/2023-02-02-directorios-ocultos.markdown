---
layout: post
title: "Encuentra directorios ocultos en la web"
img:  directorios_ocultos_banner.jpg # Add image post (optional) / size 1366x768
date: 2023-02-02 14:23:00 +0300
description: Entiende como realizar una enumeración manual para tus auditorías # Add post description (optional)
tag: [Articulo, Guia] # Video (cuando se sube a yt), Guia (explicar algo paso a paso), Articulo (hablar de algun tema de manera mas informal)
---
...
*Utilizando dirb*
```bash
dirb http://[IP]/ ../SecLists/Discovery/Web-Content/common.txt
```
* dirb = nombre de la herramienta

*Utilizando gobuster*
```bash
gobuster dir --url http://[IP]/ -w ../SecLists/Discovery/Web-Content/common.txt
```
...
```bash
wfuzz -c --hc=404 -t200 -w ../SecLists/Discovery/Web-Content/common.txt http://[IP]/FUZZ
```
