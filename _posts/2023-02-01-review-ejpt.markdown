---
layout: post
title: "Review certificación eJPT"
img:  ejpt_banner.png # Add image post (optional) / size 1366x768
date: 2023-02-01 12:55:00 +0300
description: Toda la información para preparar tu certificación en este post # Add post description (optional)
tag: [Video, Articulo] # Video (cuando se sube a yt), Guia (explicar algo paso a paso), Articulo (hablar de algun tema de manera mas informal)
---

# Toda la información para preparar tu certificación en este post
...
<img src="/assets/img/ejpt_cert.png" alt="ejpt_cert.png">
